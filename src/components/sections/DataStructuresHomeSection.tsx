...
const DataStructuresHomeSection: React.FC = () => {
  return (
    <Link
      to="/data-structures"
    ...
    >
      <div className="flex flex-col items-center text-center h-full">
        <div className="w-24 h-24 bg-gradient-to-br from-accent-light to-accent/10 border border-accent/20 rounded-3xl flex items-center justify-center mb-8 group-hover:scale-105 transition-transform duration-300">
          <Grid className="w-12 h-12 text-accent" />
        </div>
        ...
        <p className="text-secondary text-center mb-10 leading-relaxed flex-grow text-lg">
          Explore arrays, linked lists, trees, graphs, and other fundamental data structures with interactive visualizations and step-by-step explanations.
        </p>
...
export default DataStructuresHomeSection;
